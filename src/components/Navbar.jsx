...
const Navbar = () => {
  ...
  return (
    <nav
      className={`w-full h-20 z-50 sticky top-0 bg-slate-50 px-4 flex duration-[0.3s] transform ease-in-out justify-between items-center 
    ...
    >
      ...
      <div className="md:hidden">
        ...
        <div
          className={
            nav
              ? "w-[300px] absolute bg-gray-300 space-y-6 text-xl border-t z-10 cursive flex flex-col px-4 py-16 left-0 top-20"
              : "absolute left-[-100%]"
          }
          onClick={handleClick}
          style={{ marginTop: 1 }}
